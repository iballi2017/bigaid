        ...
        <div class="wrap-container">
          <div class="flex items-center justify-between">
            ...
            <a class="navbar-brand" href="./" id="primary-img">
              <img src="./assets/images/brand-logo-white-min.png" alt="BIGAiD" loading="lazy">
            </a>
            <a class="navbar-brand hidden" href="./" id="secondary-img">
              <img src="./assets/images/brand-logo-primary-min.png" alt="BIGAiD" loading="lazy">
            </a>
        ...
        <div class="wrap-container overflow-hidden w-100">
          ...
          <div class="grid md:grid-cols-12">
            ...
            <div class="md:col-span-6 order-1 md:order-2 relative fade-in">
              <div class="featured-image">
                <img src="./assets/images/space-traveller-min.png" alt="" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="wrap-container py-8">
          ...
          <ul role="list" class="gallery-type-1 | grid grid-cols-12 gap-2 md:gap-4 fade-in">
            <li class="col-span-6 md:col-span-3">
              <img src="./assets/images/Rectangle-45-min.png" alt="" loading="lazy" />
            </li>
            <li class="col-span-6 md:col-span-3">
              <img src="./assets/images/Rectangle-46-min.png" alt="" loading="lazy" />
            </li>
            <li class="col-span-6 md:col-span-3">
              <img src="./assets/images/Rectangle-47-min.png" alt="" loading="lazy" />
            </li>
            <li class="col-span-6 md:col-span-3">
              <img src="./assets/images/Rectangle-48-min.png" alt="" loading="lazy" />
            </li>
          </ul>
        </div>
      </div>
            ...
            <ul class="blob-list | grid grid-flow-row-dense grid-cols-3 grid-rows-5 gap-4">
              ...
              <li class="blob-item">
                <div class="blob fade-in" style="left: -15%">
                  <img src="./assets/images/blob-1-min.png" alt="" loading="lazy" />
                </div>
              </li>
              <li class="blob-item"></li>
              <li class="blob-item row-span-2 fade-in">
                <img src="./assets/images/phone-2-min.png" alt="" loading="lazy" />
              </li>
              <li class="blob-item col-span-2 fade-in">
                <div class="blob" style="top: -45%; left: 8%">
                  <img src="./assets/images/blob-2-min.png" alt="" loading="lazy" />
                </div>
              </li>
              <li class="blob-item fade-in">
                <div class="blob" style="top: -60%; right: -15%">
                  <img src="./assets/images/blob-3-min.png" alt="" loading="lazy" />
                </div>
              </li>
              <li class="blob-item"></li>
              <li class="blob-item"></li>
              <li class="blob-item col-span-2 fade-in">
                <div class="blob" style="top: -80%; right: -10%">
                  <img src="./assets/images/blob-4-min.png" alt="" loading="lazy" />
                </div>
              </li>
              <li class="blob-item"></li>
              <li class="blob-item fade-in">
                <div class="blob" style="top: -125%; left: -15%">
                  <img src="./assets/images/blob-5-min.png" alt="" loading="lazy" />
                </div>
              </li>
            </ul>
          </div>
            ...
            <div class="grid md:grid-cols-12 md:gap-4">
              ...
              <div class="col-span-7 relative">
                <div class="float-featured-image fade-in">
                  <img src="./assets/images/man-carry-child-min.png" alt="" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="donation-info | min-full-width">
            ...
            <div class="featured-image-container">
              <div class="featured-image fade-in">
                <img src="./assets/images/lady-card-transaction-alt-min.png" alt="" loading="lazy" />
              </div>
            </div>
          </div>
      ...
      <div class="container mx-auto">
        <div class="wrap-container">
          <div class="stay-updated-article">
            <div>
              <div class="featured-image fade-in">
                <img src="./assets/images/illustration-one-min.png" alt="" loading="lazy" />
              </div>
            </div>
            <div>
        ...
        <div class="wrap-container py-8 md:py-16">
          <div class="grid grid-cols-12 items-center">
            ...
            <div class="col-span-12 md:col-span-7">
              <div class="featured-image fade-in">
                <img src="./assets/images/illustration-email-messaging-min.png" alt="" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="grid grid-cols-12 gap-4">
              ...
              <div class="col-span-12 md:col-span-6">
                <div class="featured-image rounded-lg overflow-hidden fade-in" style="max-width: 400px; margin: 0 auto">
                  <img src="./assets/images/doctor-hand-gloves-alt-min.png" alt="" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-12 gap-2 md:gap-8">
            <div class="col-span-12 md:col-span-6">
              <div class="featured-image rounded-lg overflow-hidden fade-in">
                <img src="./assets/images/handshakes-alt-min.png" alt="" loading="lazy" />
              </div>
            </div>
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 md:col-span-5 flex items-end">
            <ul class="partners-logos">
              <li>
                <img src="./assets/images/BIGAID-foundation-logo-min.png" alt="" loading="lazy" />
              </li>
              <li>
                <img src="./assets/images/SDG-logo-min.png" alt="" loading="lazy" />
              </li>
            </ul>
          </div>
        </div>
