                ...
                <div class="col-span-12 md:col-span-7">
                    ...
                    <ul class="social-media-handles mb-4">
                        <li class="social-icon">
                            <a href="https://www.linkedin.com/company/bigaid/">
                                <span class="sr-only">LinkedIn</span>
                                <img src="../assets/icons/icon-linkedIn.svg" alt="">
                            </a>
                        </li>
                        <li class="social-icon">
                            <a href="https://facebook.com/bigaidfoundation">
                                <span class="sr-only">Facebook</span>
                                <img src="../assets/icons/icon-facebook.svg" alt="">
                            </a>
                        </li>
                        <li class="social-icon">
                            <a href="https://twitter.com/BIGAiDApp">
                                <span class="sr-only">Twitter</span>
                                <img src="../assets/icons/icon-twitter.svg" alt="">
                            </a>
                        </li>
                        <li class="social-icon">
                            <a href="https://www.instagram.com/bigaidfoundation/">
                                <span class="sr-only">Instagram</span>
                                <img src="../assets/icons/icon-instagram.svg" alt="">
                            </a>
                        </li>
                        <li class="social-icon">
                            <a href="https://www.youtube.com/@BIGAiDFoundation">
                                <span class="sr-only">Youtube</span>
                                <img src="../assets/icons/icon-youtube.svg" alt="">
                            </a>
                        </li>
                        <li class="social-icon">
                            <a href="http://tiktok.com/@bigaidfoundation">
